...
- Produce MATLAB-facing traces and a live simulator entrypoint (`hardware/run_simulation.m`)
...
1. **Credible demo path**: keep RK4TRAN validation on every step, tune reward weights, and use `hardware/run_simulation.m` for inspection.
